...
<script>
const initChips = [
  { id: 10, name: '薛之谦', type: 'brown100' },
  { id: 11, name: '邓紫棋', type: 'brown200' },
  { id: 12, name: '周深', type: 'brown300' },
  { id: 13, name: '林俊杰', type: 'brown400' },
  { id: 14, name: '周杰伦', type: 'brown500' },
  { id: 15, name: '李荣浩', type: 'brown600' }
]
export default {
  name: 'music',
  data() {
