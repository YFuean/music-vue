        ...
        <v-row justify="center">
          ...
          >
            <v-list>
              <v-list-item>
                <v-list-item-icon>
                  <v-icon color="cyan">mdi-home</v-icon>
                </v-list-item-icon>
              ...
              <v-list-item>
                <v-list-item-icon>
                  <v-icon color="teal lighten-1">mdi-apple</v-icon>
                </v-list-item-icon>
                <v-list-item-title> followers:{{ user.followers }} </v-list-item-title>
              </v-list-item>
              <v-list-item>
                <v-list-item-icon>
                  <v-icon color="pink lighten-2">mdi-star</v-icon>
                </v-list-item-icon>
                <v-list-item-title> following:{{ user.following }} </v-list-item-title>
              </v-list-item>
              <v-list-item>
                <v-list-item-icon>
                  <v-icon color="cyan">mdi-folder</v-icon>
                </v-list-item-icon>
...
export default {
  ...
  created() {
    ...
    this.axios.get('/sysAdmin/github/login?uId=' + uId).then((res) => {
      if (res.data.code === 1) {
